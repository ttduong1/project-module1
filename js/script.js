let dataRenderHome=[
  ...
  // },
  // {
  //   image:"../image.story/story34.jpg",
  //   content:" A Psychological Analysis of Adolf Hitler",
  //   price:"159.999 VNĐ",
  //   icon:"../icon/Icon1",
  //   id:8,
  //   quantity:1,
  ...
  function renderListProducts(){
    ...
    for (let i = 0; i<dataRenderHome.length; i++) {
      ...
      <div class="img-product">
        <img class="img-prd" src="${dataRenderHome[i].image}" alt="" width="250px" height="350px" />
      </div>
      <hr class="hr2" width="82%">
      <div class="content-product">
        <h5 class="content-product-3">${dataRenderHome[i].content}</h5>
        <div class="content-product-deltals" style="margin-left: -50px">
          <div class="icon2">
